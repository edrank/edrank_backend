...
func InitPrivateRoutes(r *gin.RouterGroup) {
	...
	r.POST("/feedback-questions/:type", middlewares.VerifyTenants([]string{"PARENT", "STUDENT", "HEI", "COLLEGE_ADMIN"}), controllers.GetFeedbackQuestionsController)
	...
	r.GET("/get-college-drives", middlewares.VerifyTenants([]string{"COLLEGE_ADMIN"}), controllers.GetCollegeFeedbackDrivesController)
	// parent APIs
